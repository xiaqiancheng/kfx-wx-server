...
class Task extends Entity
{
     ...
     * @var array
     */
    protected $casts = ['id' => 'integer', 'task_settle_type' => 'integer', 'task_start_time' => 'integer', 'task_end_time' => 'integer', 'task_refund_period' => 'integer', 'payment_allocate_ratio' => 'integer', 'stauts' => 'integer', 'task_tags' => 'array', 'commission' => 'integer', 'create_time' => 'integer', 'update_time' => 'integer'];
}